...
export default function HomePage() {
  ...
  /** Pre-fill the search inputs with a history entry and trigger a fresh search */
  ...
  return (
    <main className="min-h-screen bg-gray-100 flex items-start justify-center p-4 sm:p-8 pt-8">
      <div className="w-full max-w-2xl bg-white border border-gray-300 rounded shadow-sm p-6">
